function [out] = nonlinear_4DOF_maneuvering(in)
% Original source: GNC Toolbox Version 3.3, gnc/vessel_models/nv_nl_model.m
%
...
Nh = h.Nauv*au*v + h.Naur*au*r + h.Nrar*r*ar + h.Nrav*r*av...
   +h.Nbauv*b*abs(u*v) + h.Nbuar*b*u*ar + h.Nbuau*b*u*au; % fixed original typo: abs(u*b) to abs(u*v)
...
% equivalent to M^-1 * [F1, F2, F4, F6, p, r]'
